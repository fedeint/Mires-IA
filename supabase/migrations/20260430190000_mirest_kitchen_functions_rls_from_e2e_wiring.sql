-- Complementa aplicaciones parciales de 20260430180000: RLS mpr, GRANT, y
-- reemplazo de fn_trg_order_item_cocina + fn_cocina_listo_descuenta_stock.
-- Idempotente. Si ya estaba todo aplicado, solo reemplaza cuerpos iguales.

-- Eliminar política antigua si existía bajo otro nombre (nombres alternos en pruebas).
DROP POLICY IF EXISTS mpr_tenant ON public.menu_product_recipes;
DROP POLICY IF EXISTS menu_product_recipes_tenant_policy ON public.menu_product_recipes;
